...
public class AddToCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Tbl_TeaDTO tea = new Tbl_TeaDTO(tmp[0], tmp[1], Float.parseFloat(tmp[2]), 1);
            ...
            url = SUCCESS;
            request.setAttribute("message", "You added: " + tmp[1] + " successfully to your cart !");            
        } catch (Exception e) {
            log("Error ar AddToCartServlet " + e.toString());
        } finally {
